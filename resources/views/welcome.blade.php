                            ...
                            <ul class="card-meta list-inline mb-0">
                                ...
                                <li class="list-inline-item mb-0">
                                    <ul class="card-meta-tag list-inline">
                                        <li class="list-inline-item"><a href="{{ route('details', $new->id) }}">{{
                                                $new->category_name }}</a>
                                        </li>
                                    </ul>
                                </li>
            ...
            <div class="col-lg-8 mb-5 mb-lg-0">
                ...
                <article class="card mb-4">
                    <div class="post-slider">
                        ...
                        <article class="card mb-4">
                            <div class="post-slider">
                                <img src="{{ \Storage::url($post->image) }}" style="height: 400px; width: 100%; class="
                                    card-img-top" alt="post-thumb">
                            </div>
                            <div class="card-body">
                                <h3 class="h4 mb-3"><a class="post-title" href="{{ route('details', $post->id) }}">{{
                                        $post->title }}</a></h3>
